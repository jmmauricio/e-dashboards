...
out[0] = -p[25]*x[0] + p[15]*(x[1] - y[13]);
out[1] = (1.0/2.0)*(-p[23]*(x[1] - y[13]) - y[6]*(p[24]*y[6] + y[0]*sin(x[0] - y[1])) - y[7]*(p[24]*y[7] + y[0]*cos(x[0] - y[1])) + y[12])/p[16];
out[2] = (-x[2] - y[6]*(-p[21] + p[19]) + y[10])/p[17];
out[3] = (-x[3] + y[7]*(-p[22] + p[20]))/p[18];
out[4] = (y[0] - x[4])/p[29];
out[5] = -p[32]*(p[27]*(-x[4] + u[7] + u[6]) + p[28]*x[5] - y[10]) - x[4] + u[7] + u[6];
out[6] = (y[11] - x[6])/p[34];
out[7] = (x[6] - x[7])/p[36];
out[8] = p[37]*(u[8] - y[8]) - 9.9999999999999995e-7*x[8];
out[9] = 1 - y[13];

}
void g_ini_eval(double *out,double *x,double *y,double *u,double *p,double Dt){

out[0] = -u[0]/p[0] + pow(y[0], 2)*(p[1] + p[7]/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2))) + y[0]*y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) + (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3])) + y[0]*y[4]*(-p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5])) - p[14]*y[8]/p[0];
out[1] = -u[1]/p[0] + pow(y[0], 2)*(-p[2] - p[8]/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - 1.0/2.0*p[3]) + y[0]*y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3])) + y[0]*y[4]*(p[2]*cos(y[1] - y[5]) - p[1]*sin(y[1] - y[5])) - p[14]*y[9]/p[0];
out[2] = -u[2]/p[0] + y[0]*y[2]*((-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3])) + pow(y[2], 2)*(p[4] + p[7]) + y[2]*y[4]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[3] = -u[3]/p[0] + y[0]*y[2]*(-(-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3])) + pow(y[2], 2)*(-p[5] - p[8] - 1.0/2.0*p[6]) + y[2]*y[4]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[4] = -u[4]/p[0] + y[0]*y[4]*(p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5])) + y[2]*y[4]*(p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5])) + pow(y[4], 2)*(p[1] + p[4]);
out[5] = -u[5]/p[0] + y[0]*y[4]*(p[2]*cos(y[1] - y[5]) + p[1]*sin(y[1] - y[5])) + y[2]*y[4]*(p[5]*cos(y[3] - y[5]) + p[4]*sin(y[3] - y[5])) + pow(y[4], 2)*(-p[2] - p[5] - 1.0/2.0*p[3] - 1.0/2.0*p[6]);
out[6] = p[24]*y[7] + y[0]*cos(x[0] - y[1]) + p[21]*y[6] - x[2];
out[7] = p[24]*y[6] + y[0]*sin(x[0] - y[1]) - p[22]*y[7] - x[3];
out[8] = y[0]*y[6]*sin(x[0] - y[1]) + y[0]*y[7]*cos(x[0] - y[1]) - y[8];
out[9] = y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]) - y[9];
out[10] = -y[10] + ((p[30] > p[27]*(-x[4] + u[7] + u[6]) + p[28]*x[5]) ? (
   p[30]
)
: ((p[31] < p[27]*(-x[4] + u[7] + u[6]) + p[28]*x[5]) ? (
   p[31]
)
: (
   p[27]*(-x[4] + u[7] + u[6]) + p[28]*x[5]
)));
out[11] = p[26]*y[14] - y[11] + u[9] + x[8] - (x[1] - p[38])/p[33];
out[12] = p[35]*(x[6] - x[7])/p[36] - y[12] + x[7];
out[13] = x[1] - y[13];
out[14] = p[40]*x[9] + p[39]*(1 - y[13]) - y[14];
...
out[1] = y[2];
out[2] = y[4];
out[3] = pow(y[0], 2)*p[1] + y[0]*y[4]*(-p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5]));
out[4] = -pow(y[0], 2)*p[2] + y[0]*y[4]*(p[2]*cos(y[1] - y[5]) - p[1]*sin(y[1] - y[5]));
out[5] = pow(y[2], 2)*p[4] + y[2]*y[4]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[6] = -pow(y[2], 2)*p[5] + y[2]*y[4]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[7] = y[6]*(p[24]*y[6] + y[0]*sin(x[0] - y[1])) + y[7]*(p[24]*y[7] + y[0]*cos(x[0] - y[1]));

}
void de_jac_ini_xy_eval(double *out,double *x,double *y,double *u,double *p,double Dt){

out[25] = 0.5*(-y[0]*y[6]*cos(x[0] - y[1]) + y[0]*y[7]*sin(x[0] - y[1]))/p[16];
out[35] = 0.5*(-y[6]*sin(x[0] - y[1]) - y[7]*cos(x[0] - y[1]))/p[16];
out[36] = 0.5*(y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]))/p[16];
out[41] = 0.5*(-2.0*p[24]*y[6] - y[0]*sin(x[0] - y[1]))/p[16];
out[42] = 0.5*(-2.0*p[24]*y[7] - y[0]*cos(x[0] - y[1]))/p[16];
out[260] = 2.0*y[0]*(p[1] + p[7]/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2))) + y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) + (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3])) + y[4]*(-p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5]));
out[261] = y[0]*y[2]*(-(p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) + (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3])) + y[0]*y[4]*(-p[2]*cos(y[1] - y[5]) + p[1]*sin(y[1] - y[5]));
out[262] = y[0]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) + (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]));
out[263] = y[0]*y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]));
out[264] = y[0]*(-p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5]));
out[265] = y[0]*y[4]*(p[2]*cos(y[1] - y[5]) - p[1]*sin(y[1] - y[5]));
out[285] = 2.0*y[0]*(-p[2] - p[8]/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - 0.5*p[3]) + y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3])) + y[4]*(p[2]*cos(y[1] - y[5]) - p[1]*sin(y[1] - y[5]));
out[286] = y[0]*y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) - (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3])) + y[0]*y[4]*(-p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5]));
out[287] = y[0]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]));
out[288] = y[0]*y[2]*(-(p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) + (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]));
out[289] = y[0]*(p[2]*cos(y[1] - y[5]) - p[1]*sin(y[1] - y[5]));
out[290] = y[0]*y[4]*(p[2]*sin(y[1] - y[5]) + p[1]*cos(y[1] - y[5]));
out[310] = y[2]*((-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]));
out[311] = y[0]*y[2]*(-(-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) + (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]));
out[312] = y[0]*((-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3])) + 2.0*y[2]*(p[4] + p[7]) + y[4]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[313] = y[0]*y[2]*((-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3])) + y[2]*y[4]*(-p[5]*cos(y[3] - y[5]) + p[4]*sin(y[3] - y[5]));
out[314] = y[2]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[315] = y[2]*y[4]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[335] = y[2]*(-(-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]));
out[336] = y[0]*y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) - (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]));
out[337] = y[0]*(-(-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3])) + 2.0*y[2]*(-p[5] - p[8] - 0.5*p[6]) + y[4]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[338] = y[0]*y[2]*(-(p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) + (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3])) + y[2]*y[4]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[339] = y[2]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[340] = y[2]*y[4]*(p[5]*sin(y[3] - y[5]) + p[4]*cos(y[3] - y[5]));
out[360] = y[4]*(p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5]));
out[361] = y[0]*y[4]*(p[2]*cos(y[1] - y[5]) + p[1]*sin(y[1] - y[5]));
out[362] = y[4]*(p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[363] = y[2]*y[4]*(p[5]*cos(y[3] - y[5]) + p[4]*sin(y[3] - y[5]));
out[364] = y[0]*(p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5])) + y[2]*(p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5])) + 2.0*y[4]*(p[1] + p[4]);
out[365] = y[0]*y[4]*(-p[2]*cos(y[1] - y[5]) - p[1]*sin(y[1] - y[5])) + y[2]*y[4]*(-p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[385] = y[4]*(p[2]*cos(y[1] - y[5]) + p[1]*sin(y[1] - y[5]));
out[386] = y[0]*y[4]*(-p[2]*sin(y[1] - y[5]) + p[1]*cos(y[1] - y[5]));
out[387] = y[4]*(p[5]*cos(y[3] - y[5]) + p[4]*sin(y[3] - y[5]));
out[388] = y[2]*y[4]*(-p[5]*sin(y[3] - y[5]) + p[4]*cos(y[3] - y[5]));
out[389] = y[0]*(p[2]*cos(y[1] - y[5]) + p[1]*sin(y[1] - y[5])) + y[2]*(p[5]*cos(y[3] - y[5]) + p[4]*sin(y[3] - y[5])) + 2.0*y[4]*(-p[2] - p[5] - 0.5*p[3] - 0.5*p[6]);
out[390] = y[0]*y[4]*(p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5])) + y[2]*y[4]*(p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[400] = -y[0]*sin(x[0] - y[1]);
out[410] = cos(x[0] - y[1]);
out[411] = y[0]*sin(x[0] - y[1]);
out[425] = y[0]*cos(x[0] - y[1]);
out[435] = sin(x[0] - y[1]);
out[436] = -y[0]*cos(x[0] - y[1]);
out[450] = y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]);
out[460] = y[6]*sin(x[0] - y[1]) + y[7]*cos(x[0] - y[1]);
out[461] = -y[0]*y[6]*cos(x[0] - y[1]) + y[0]*y[7]*sin(x[0] - y[1]);
out[466] = y[0]*sin(x[0] - y[1]);
out[467] = y[0]*cos(x[0] - y[1]);
out[475] = -y[0]*y[6]*sin(x[0] - y[1]) - y[0]*y[7]*cos(x[0] - y[1]);
out[485] = y[6]*cos(x[0] - y[1]) - y[7]*sin(x[0] - y[1]);
out[486] = y[0]*y[6]*sin(x[0] - y[1]) + y[0]*y[7]*cos(x[0] - y[1]);
out[491] = y[0]*cos(x[0] - y[1]);
out[492] = -y[0]*sin(x[0] - y[1]);
out[504] = ((p[30] > p[27]*(-x[4] + u[7] + u[6]) + p[28]*x[5] || p[31] < p[27]*(-x[4] + u[7] + u[6]) + p[28]*x[5]) ? (
   0
)
: (
   -p[27]
));
out[505] = ((p[30] > p[27]*(-x[4] + u[7] + u[6]) + p[28]*x[5] || p[31] < p[27]*(-x[4] + u[7] + u[6]) + p[28]*x[5]) ? (
   0
)
: (
   p[28]
...
out[1] = p[15];
out[23] = -p[15];
out[26] = -0.5*p[23]/p[16];
out[47] = 0.5/p[16];
out[48] = 0.5*p[23]/p[16];
out[52] = -1/p[17];
out[66] = (p[21] - p[19])/p[17];
out[70] = 1.0/p[17];
out[78] = -1/p[18];
out[92] = (-p[22] + p[20])/p[18];
out[104] = -1/p[29];
out[110] = 1.0/p[29];
out[129] = p[27]*p[32] - 1.0;
out[130] = -p[28]*p[32];
out[145] = p[32];
out[156] = -1/p[34];
out[171] = 1.0/p[34];
...
out[3] = 0.5*(-y[0]*y[6]*cos(x[0] - y[1]) + y[0]*y[7]*sin(x[0] - y[1]))/p[16];
out[5] = 0.5*(-y[6]*sin(x[0] - y[1]) - y[7]*cos(x[0] - y[1]))/p[16];
out[6] = 0.5*(y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]))/p[16];
out[7] = 0.5*(-2.0*p[24]*y[6] - y[0]*sin(x[0] - y[1]))/p[16];
out[8] = 0.5*(-2.0*p[24]*y[7] - y[0]*cos(x[0] - y[1]))/p[16];
out[28] = 2.0*y[0]*(p[1] + p[7]/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2))) + y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) + (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3])) + y[4]*(-p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5]));
out[29] = y[0]*y[2]*(-(p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) + (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3])) + y[0]*y[4]*(-p[2]*cos(y[1] - y[5]) + p[1]*sin(y[1] - y[5]));
out[30] = y[0]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) + (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]));
out[31] = y[0]*y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]));
out[32] = y[0]*(-p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5]));
out[33] = y[0]*y[4]*(p[2]*cos(y[1] - y[5]) - p[1]*sin(y[1] - y[5]));
out[35] = 2.0*y[0]*(-p[2] - p[8]/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - 0.5*p[3]) + y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3])) + y[4]*(p[2]*cos(y[1] - y[5]) - p[1]*sin(y[1] - y[5]));
out[36] = y[0]*y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) - (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3])) + y[0]*y[4]*(-p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5]));
out[37] = y[0]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]));
out[38] = y[0]*y[2]*(-(p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) + (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]));
out[39] = y[0]*(p[2]*cos(y[1] - y[5]) - p[1]*sin(y[1] - y[5]));
out[40] = y[0]*y[4]*(p[2]*sin(y[1] - y[5]) + p[1]*cos(y[1] - y[5]));
out[42] = y[2]*((-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]));
out[43] = y[0]*y[2]*(-(-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) + (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]));
out[44] = y[0]*((-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3])) + 2.0*y[2]*(p[4] + p[7]) + y[4]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[45] = y[0]*y[2]*((-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3])) + y[2]*y[4]*(-p[5]*cos(y[3] - y[5]) + p[4]*sin(y[3] - y[5]));
out[46] = y[2]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[47] = y[2]*y[4]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[48] = y[2]*(-(-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]));
out[49] = y[0]*y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) - (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]));
out[50] = y[0]*(-(-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3])) + 2.0*y[2]*(-p[5] - p[8] - 0.5*p[6]) + y[4]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[51] = y[0]*y[2]*(-(p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) + (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3])) + y[2]*y[4]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[52] = y[2]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[53] = y[2]*y[4]*(p[5]*sin(y[3] - y[5]) + p[4]*cos(y[3] - y[5]));
out[54] = y[4]*(p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5]));
out[55] = y[0]*y[4]*(p[2]*cos(y[1] - y[5]) + p[1]*sin(y[1] - y[5]));
out[56] = y[4]*(p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[57] = y[2]*y[4]*(p[5]*cos(y[3] - y[5]) + p[4]*sin(y[3] - y[5]));
out[58] = y[0]*(p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5])) + y[2]*(p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5])) + 2.0*y[4]*(p[1] + p[4]);
out[59] = y[0]*y[4]*(-p[2]*cos(y[1] - y[5]) - p[1]*sin(y[1] - y[5])) + y[2]*y[4]*(-p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[60] = y[4]*(p[2]*cos(y[1] - y[5]) + p[1]*sin(y[1] - y[5]));
out[61] = y[0]*y[4]*(-p[2]*sin(y[1] - y[5]) + p[1]*cos(y[1] - y[5]));
out[62] = y[4]*(p[5]*cos(y[3] - y[5]) + p[4]*sin(y[3] - y[5]));
out[63] = y[2]*y[4]*(-p[5]*sin(y[3] - y[5]) + p[4]*cos(y[3] - y[5]));
out[64] = y[0]*(p[2]*cos(y[1] - y[5]) + p[1]*sin(y[1] - y[5])) + y[2]*(p[5]*cos(y[3] - y[5]) + p[4]*sin(y[3] - y[5])) + 2.0*y[4]*(-p[2] - p[5] - 0.5*p[3] - 0.5*p[6]);
out[65] = y[0]*y[4]*(p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5])) + y[2]*y[4]*(p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[66] = -y[0]*sin(x[0] - y[1]);
out[68] = cos(x[0] - y[1]);
out[69] = y[0]*sin(x[0] - y[1]);
out[72] = y[0]*cos(x[0] - y[1]);
out[74] = sin(x[0] - y[1]);
out[75] = -y[0]*cos(x[0] - y[1]);
out[78] = y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]);
out[79] = y[6]*sin(x[0] - y[1]) + y[7]*cos(x[0] - y[1]);
out[80] = -y[0]*y[6]*cos(x[0] - y[1]) + y[0]*y[7]*sin(x[0] - y[1]);
out[81] = y[0]*sin(x[0] - y[1]);
out[82] = y[0]*cos(x[0] - y[1]);
out[84] = -y[0]*y[6]*sin(x[0] - y[1]) - y[0]*y[7]*cos(x[0] - y[1]);
out[85] = y[6]*cos(x[0] - y[1]) - y[7]*sin(x[0] - y[1]);
out[86] = y[0]*y[6]*sin(x[0] - y[1]) + y[0]*y[7]*cos(x[0] - y[1]);
out[87] = y[0]*cos(x[0] - y[1]);
out[88] = -y[0]*sin(x[0] - y[1]);
out[90] = ((p[30] > p[27]*(-x[4] + u[7] + u[6]) + p[28]*x[5] || p[31] < p[27]*(-x[4] + u[7] + u[6]) + p[28]*x[5]) ? (
   0
)
: (
   -p[27]
));
out[91] = ((p[30] > p[27]*(-x[4] + u[7] + u[6]) + p[28]*x[5] || p[31] < p[27]*(-x[4] + u[7] + u[6]) + p[28]*x[5]) ? (
   0
)
: (
   p[28]
...
out[4] = -0.5*p[23]/p[16];
out[9] = 0.5/p[16];
out[10] = 0.5*p[23]/p[16];
out[11] = -1/p[17];
out[12] = (p[21] - p[19])/p[17];
out[13] = 1.0/p[17];
out[14] = -1/p[18];
out[15] = (-p[22] + p[20])/p[18];
out[16] = -1/p[29];
out[17] = 1.0/p[29];
out[18] = p[27]*p[32] - 1.0;
out[19] = -p[28]*p[32];
out[20] = p[32];
out[21] = -1/p[34];
out[22] = 1.0/p[34];
...
out[25] = -0.25*Dt*(-y[0]*y[6]*cos(x[0] - y[1]) + y[0]*y[7]*sin(x[0] - y[1]))/p[16];
out[35] = -0.25*Dt*(-y[6]*sin(x[0] - y[1]) - y[7]*cos(x[0] - y[1]))/p[16];
out[36] = -0.25*Dt*(y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]))/p[16];
out[41] = -0.25*Dt*(-2.0*p[24]*y[6] - y[0]*sin(x[0] - y[1]))/p[16];
out[42] = -0.25*Dt*(-2.0*p[24]*y[7] - y[0]*cos(x[0] - y[1]))/p[16];
out[260] = 2.0*y[0]*(p[1] + p[7]/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2))) + y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) + (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3])) + y[4]*(-p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5]));
out[261] = y[0]*y[2]*(-(p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) + (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3])) + y[0]*y[4]*(-p[2]*cos(y[1] - y[5]) + p[1]*sin(y[1] - y[5]));
out[262] = y[0]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) + (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]));
out[263] = y[0]*y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]));
...
out[0] = 0.5*Dt*p[25] + 1.0;
out[1] = -0.5*Dt*p[15];
out[23] = 0.5*Dt*p[15];
out[26] = 0.25*p[23]*Dt/p[16] + 1.0;
out[47] = -0.25*Dt/p[16];
out[48] = -0.25*p[23]*Dt/p[16];
out[52] = 0.5*Dt/p[17] + 1.0;
out[66] = -0.5*Dt*(p[21] - p[19])/p[17];
out[70] = -0.5*Dt/p[17];
out[78] = 0.5*Dt/p[18] + 1.0;
out[92] = -0.5*Dt*(-p[22] + p[20])/p[18];
out[104] = 0.5*Dt/p[29] + 1.0;
out[110] = -0.5*Dt/p[29];
out[129] = -0.5*Dt*(p[27]*p[32] - 1.0);
out[130] = 0.5*Dt*p[28]*p[32] + 1.0;
out[145] = -0.5*Dt*p[32];
out[156] = 0.5*Dt/p[34] + 1.0;
out[171] = -0.5*Dt/p[34];
out[181] = -0.5*Dt/p[36];
out[182] = 0.5*Dt/p[36] + 1.0;
out[208] = 4.9999999999999998e-7*Dt + 1.0;
out[218] = 0.5*Dt*p[37];
out[248] = 0.5*Dt;
out[268] = -p[14]/p[0];
out[294] = -p[14]/p[0];
...
out[3] = -0.25*Dt*(-y[0]*y[6]*cos(x[0] - y[1]) + y[0]*y[7]*sin(x[0] - y[1]))/p[16];
out[5] = -0.25*Dt*(-y[6]*sin(x[0] - y[1]) - y[7]*cos(x[0] - y[1]))/p[16];
out[6] = -0.25*Dt*(y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]))/p[16];
out[7] = -0.25*Dt*(-2.0*p[24]*y[6] - y[0]*sin(x[0] - y[1]))/p[16];
out[8] = -0.25*Dt*(-2.0*p[24]*y[7] - y[0]*cos(x[0] - y[1]))/p[16];
out[29] = 2.0*y[0]*(p[1] + p[7]/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2))) + y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) + (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3])) + y[4]*(-p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5]));
out[30] = y[0]*y[2]*(-(p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) + (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3])) + y[0]*y[4]*(-p[2]*cos(y[1] - y[5]) + p[1]*sin(y[1] - y[5]));
out[31] = y[0]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) + (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]));
out[32] = y[0]*y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]));
out[33] = y[0]*(-p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5]));
out[34] = y[0]*y[4]*(p[2]*cos(y[1] - y[5]) - p[1]*sin(y[1] - y[5]));
out[36] = 2.0*y[0]*(-p[2] - p[8]/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - 0.5*p[3]) + y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3])) + y[4]*(p[2]*cos(y[1] - y[5]) - p[1]*sin(y[1] - y[5]));
out[37] = y[0]*y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) - (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3])) + y[0]*y[4]*(-p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5]));
out[38] = y[0]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]));
out[39] = y[0]*y[2]*(-(p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) + (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]));
out[40] = y[0]*(p[2]*cos(y[1] - y[5]) - p[1]*sin(y[1] - y[5]));
out[41] = y[0]*y[4]*(p[2]*sin(y[1] - y[5]) + p[1]*cos(y[1] - y[5]));
out[43] = y[2]*((-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]));
out[44] = y[0]*y[2]*(-(-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) + (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]));
out[45] = y[0]*((-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3])) + 2.0*y[2]*(p[4] + p[7]) + y[4]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[46] = y[0]*y[2]*((-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3])) + y[2]*y[4]*(-p[5]*cos(y[3] - y[5]) + p[4]*sin(y[3] - y[5]));
out[47] = y[2]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[48] = y[2]*y[4]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[49] = y[2]*(-(-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]));
out[50] = y[0]*y[2]*((p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) - (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]));
out[51] = y[0]*(-(-p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3]) - (-p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3])) + 2.0*y[2]*(-p[5] - p[8] - 0.5*p[6]) + y[4]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[52] = y[0]*y[2]*(-(p[8]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) + p[7]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*cos(y[1] - y[3]) + (p[8]*p[9]*cos(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)) - p[7]*p[9]*sin(p[10])/(pow(p[9], 2)*pow(sin(p[10]), 2) + pow(p[9], 2)*pow(cos(p[10]), 2)))*sin(y[1] - y[3])) + y[2]*y[4]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[53] = y[2]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[54] = y[2]*y[4]*(p[5]*sin(y[3] - y[5]) + p[4]*cos(y[3] - y[5]));
out[55] = y[4]*(p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5]));
out[56] = y[0]*y[4]*(p[2]*cos(y[1] - y[5]) + p[1]*sin(y[1] - y[5]));
out[57] = y[4]*(p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[58] = y[2]*y[4]*(p[5]*cos(y[3] - y[5]) + p[4]*sin(y[3] - y[5]));
out[59] = y[0]*(p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5])) + y[2]*(p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5])) + 2.0*y[4]*(p[1] + p[4]);
out[60] = y[0]*y[4]*(-p[2]*cos(y[1] - y[5]) - p[1]*sin(y[1] - y[5])) + y[2]*y[4]*(-p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[61] = y[4]*(p[2]*cos(y[1] - y[5]) + p[1]*sin(y[1] - y[5]));
out[62] = y[0]*y[4]*(-p[2]*sin(y[1] - y[5]) + p[1]*cos(y[1] - y[5]));
out[63] = y[4]*(p[5]*cos(y[3] - y[5]) + p[4]*sin(y[3] - y[5]));
out[64] = y[2]*y[4]*(-p[5]*sin(y[3] - y[5]) + p[4]*cos(y[3] - y[5]));
out[65] = y[0]*(p[2]*cos(y[1] - y[5]) + p[1]*sin(y[1] - y[5])) + y[2]*(p[5]*cos(y[3] - y[5]) + p[4]*sin(y[3] - y[5])) + 2.0*y[4]*(-p[2] - p[5] - 0.5*p[3] - 0.5*p[6]);
out[66] = y[0]*y[4]*(p[2]*sin(y[1] - y[5]) - p[1]*cos(y[1] - y[5])) + y[2]*y[4]*(p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
...
out[79] = y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]);
out[80] = y[6]*sin(x[0] - y[1]) + y[7]*cos(x[0] - y[1]);
out[81] = -y[0]*y[6]*cos(x[0] - y[1]) + y[0]*y[7]*sin(x[0] - y[1]);
out[82] = y[0]*sin(x[0] - y[1]);
out[83] = y[0]*cos(x[0] - y[1]);
out[85] = -y[0]*y[6]*sin(x[0] - y[1]) - y[0]*y[7]*cos(x[0] - y[1]);
out[86] = y[6]*cos(x[0] - y[1]) - y[7]*sin(x[0] - y[1]);
out[87] = y[0]*y[6]*sin(x[0] - y[1]) + y[0]*y[7]*cos(x[0] - y[1]);
out[88] = y[0]*cos(x[0] - y[1]);
out[89] = -y[0]*sin(x[0] - y[1]);
out[91] = ((p[30] > p[27]*(-x[4] + u[7] + u[6]) + p[28]*x[5] || p[31] < p[27]*(-x[4] + u[7] + u[6]) + p[28]*x[5]) ? (
   0
)
: (
...
out[92] = ((p[30] > p[27]*(-x[4] + u[7] + u[6]) + p[28]*x[5] || p[31] < p[27]*(-x[4] + u[7] + u[6]) + p[28]*x[5]) ? (
   0
)
: (
   p[28]
...
out[1] = -0.5*Dt*p[15];
out[2] = 0.5*Dt*p[15];
out[4] = 0.25*p[23]*Dt/p[16] + 1.0;
out[9] = -0.25*Dt/p[16];
out[10] = -0.25*p[23]*Dt/p[16];
out[11] = 0.5*Dt/p[17] + 1.0;
out[12] = -0.5*Dt*(p[21] - p[19])/p[17];
out[13] = -0.5*Dt/p[17];
out[14] = 0.5*Dt/p[18] + 1.0;
out[15] = -0.5*Dt*(-p[22] + p[20])/p[18];
out[16] = 0.5*Dt/p[29] + 1.0;
out[17] = -0.5*Dt/p[29];
out[18] = -0.5*Dt*(p[27]*p[32] - 1.0);
out[19] = 0.5*Dt*p[28]*p[32] + 1.0;
out[20] = -0.5*Dt*p[32];
out[21] = 0.5*Dt/p[34] + 1.0;
out[22] = -0.5*Dt/p[34];
out[23] = -0.5*Dt/p[36];
out[24] = 0.5*Dt/p[36] + 1.0;
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_trafo_shift_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_trafo_shift_cffi(void) { return NULL; }
#  else
     inittrafo_shift_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_trafo_shift_cffi(void)
{
  return _cffi_init("trafo_shift_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
inittrafo_shift_cffi(void)
{
  _cffi_init("trafo_shift_cffi", 0x2601, &_cffi_type_context);
}
#endif
