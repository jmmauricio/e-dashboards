...
out[0] = -p[17]*x[0] + p[7]*(x[1] - y[18]);
out[1] = (1.0/2.0)*(-p[15]*(x[1] - y[18]) - y[4]*(p[16]*y[4] + y[0]*sin(x[0] - y[1])) - y[5]*(p[16]*y[5] + y[0]*cos(x[0] - y[1])) + y[10])/p[8];
out[2] = (-x[2] - y[4]*(-p[13] + p[11]) + y[8])/p[9];
out[3] = (-x[3] + y[5]*(-p[14] + p[12]))/p[10];
out[4] = (y[0] - x[4])/p[21];
out[5] = -p[24]*(p[19]*(-x[4] + u[5] + u[4]) + p[20]*x[5] - y[8]) - x[4] + u[5] + u[4];
out[6] = (y[9] - x[6])/p[26];
out[7] = (x[6] - x[7])/p[28];
out[8] = p[29]*(u[6] - y[6]) - 9.9999999999999995e-7*x[8];
out[9] = -p[42]*x[9] + p[32]*(x[10] - y[18]);
out[10] = (1.0/2.0)*(-p[40]*(x[10] - y[18]) - y[11]*(p[41]*y[11] + y[2]*sin(x[9] - y[3])) - y[12]*(p[41]*y[12] + y[2]*cos(x[9] - y[3])) + y[17])/p[33];
out[11] = (-x[11] - y[11]*(-p[38] + p[36]) + y[15])/p[34];
out[12] = (-x[12] + y[12]*(-p[39] + p[37]))/p[35];
out[13] = (y[2] - x[13])/p[46];
out[14] = -p[49]*(p[44]*(-x[13] + u[9] + u[8]) + p[45]*x[14] - y[15]) - x[13] + u[9] + u[8];
out[15] = (y[16] - x[15])/p[51];
out[16] = (x[15] - x[16])/p[53];
out[17] = p[54]*(u[10] - y[13]) - 9.9999999999999995e-7*x[17];
out[18] = 1 - y[18];
...
out[2] = -u[2]/p[0] + y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + pow(y[2], 2)*p[1] - p[31]*y[13]/p[0];
out[3] = -u[3]/p[0] + y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + pow(y[2], 2)*(-p[2] - 1.0/2.0*p[3]) - p[31]*y[14]/p[0];
...
out[8] = -y[8] + ((p[22] > p[19]*(-x[4] + u[5] + u[4]) + p[20]*x[5]) ? (
   p[22]
)
: ((p[23] < p[19]*(-x[4] + u[5] + u[4]) + p[20]*x[5]) ? (
   p[23]
)
: (
   p[19]*(-x[4] + u[5] + u[4]) + p[20]*x[5]
)));
out[9] = p[18]*y[19] - y[9] + u[7] + x[8] - (x[1] - p[30])/p[25];
out[10] = p[27]*(x[6] - x[7])/p[28] - y[10] + x[7];
out[11] = p[41]*y[12] + y[2]*cos(x[9] - y[3]) + p[38]*y[11] - x[11];
out[12] = p[41]*y[11] + y[2]*sin(x[9] - y[3]) - p[39]*y[12] - x[12];
out[13] = y[2]*y[11]*sin(x[9] - y[3]) + y[2]*y[12]*cos(x[9] - y[3]) - y[13];
out[14] = y[2]*y[11]*cos(x[9] - y[3]) - y[2]*y[12]*sin(x[9] - y[3]) - y[14];
out[15] = -y[15] + ((p[47] > p[44]*(-x[13] + u[9] + u[8]) + p[45]*x[14]) ? (
   p[47]
)
: ((p[48] < p[44]*(-x[13] + u[9] + u[8]) + p[45]*x[14]) ? (
   p[48]
)
: (
   p[44]*(-x[13] + u[9] + u[8]) + p[45]*x[14]
)));
out[16] = p[43]*y[19] - y[16] + u[11] + x[17] - (x[10] - p[55])/p[50];
out[17] = p[52]*(x[15] - x[16])/p[53] - y[17] + x[16];
out[18] = -y[18] + (p[8]*p[6]*x[1] + p[33]*p[31]*x[10])/(p[8]*p[6] + p[33]*p[31]);
out[19] = p[57]*x[18] + p[56]*(1 - y[18]) - y[19];
...
out[3] = y[11]*(p[41]*y[11] + y[2]*sin(x[9] - y[3])) + y[12]*(p[41]*y[12] + y[2]*cos(x[9] - y[3]));

}
void de_jac_ini_xy_eval(double *out,double *x,double *y,double *u,double *p,double Dt){

out[39] = 0.5*(-y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]))/p[8];
out[58] = 0.5*(-y[4]*sin(x[0] - y[1]) - y[5]*cos(x[0] - y[1]))/p[8];
out[59] = 0.5*(y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]))/p[8];
out[62] = 0.5*(-2.0*p[16]*y[4] - y[0]*sin(x[0] - y[1]))/p[8];
out[63] = 0.5*(-2.0*p[16]*y[5] - y[0]*cos(x[0] - y[1]))/p[8];
out[399] = 0.5*(-y[2]*y[11]*cos(x[9] - y[3]) + y[2]*y[12]*sin(x[9] - y[3]))/p[33];
out[411] = 0.5*(-y[11]*sin(x[9] - y[3]) - y[12]*cos(x[9] - y[3]))/p[33];
out[412] = 0.5*(y[2]*y[11]*cos(x[9] - y[3]) - y[2]*y[12]*sin(x[9] - y[3]))/p[33];
out[420] = 0.5*(-2.0*p[41]*y[11] - y[2]*sin(x[9] - y[3]))/p[33];
out[421] = 0.5*(-2.0*p[41]*y[12] - y[2]*cos(x[9] - y[3]))/p[33];
out[760] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[761] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[762] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[763] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[799] = 2.0*y[0]*(-p[2] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[800] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[801] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[802] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[838] = y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[839] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[840] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*p[1];
out[841] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[877] = y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[878] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[879] = y[0]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + 2.0*y[2]*(-p[2] - 0.5*p[3]);
out[880] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[897] = -y[0]*sin(x[0] - y[1]);
out[916] = cos(x[0] - y[1]);
out[917] = y[0]*sin(x[0] - y[1]);
out[936] = y[0]*cos(x[0] - y[1]);
out[955] = sin(x[0] - y[1]);
out[956] = -y[0]*cos(x[0] - y[1]);
out[975] = y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]);
out[994] = y[4]*sin(x[0] - y[1]) + y[5]*cos(x[0] - y[1]);
out[995] = -y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]);
out[998] = y[0]*sin(x[0] - y[1]);
out[999] = y[0]*cos(x[0] - y[1]);
out[1014] = -y[0]*y[4]*sin(x[0] - y[1]) - y[0]*y[5]*cos(x[0] - y[1]);
out[1033] = y[4]*cos(x[0] - y[1]) - y[5]*sin(x[0] - y[1]);
out[1034] = y[0]*y[4]*sin(x[0] - y[1]) + y[0]*y[5]*cos(x[0] - y[1]);
out[1037] = y[0]*cos(x[0] - y[1]);
out[1038] = -y[0]*sin(x[0] - y[1]);
out[1057] = ((p[22] > p[19]*(-x[4] + u[5] + u[4]) + p[20]*x[5] || p[23] < p[19]*(-x[4] + u[5] + u[4]) + p[20]*x[5]) ? (
   0
)
: (
   -p[19]
));
out[1058] = ((p[22] > p[19]*(-x[4] + u[5] + u[4]) + p[20]*x[5] || p[23] < p[19]*(-x[4] + u[5] + u[4]) + p[20]*x[5]) ? (
   0
)
: (
   p[20]
));
out[1179] = -y[2]*sin(x[9] - y[3]);
out[1191] = cos(x[9] - y[3]);
out[1192] = y[2]*sin(x[9] - y[3]);
out[1218] = y[2]*cos(x[9] - y[3]);
out[1230] = sin(x[9] - y[3]);
out[1231] = -y[2]*cos(x[9] - y[3]);
out[1257] = y[2]*y[11]*cos(x[9] - y[3]) - y[2]*y[12]*sin(x[9] - y[3]);
out[1269] = y[11]*sin(x[9] - y[3]) + y[12]*cos(x[9] - y[3]);
out[1270] = -y[2]*y[11]*cos(x[9] - y[3]) + y[2]*y[12]*sin(x[9] - y[3]);
out[1278] = y[2]*sin(x[9] - y[3]);
out[1279] = y[2]*cos(x[9] - y[3]);
out[1296] = -y[2]*y[11]*sin(x[9] - y[3]) - y[2]*y[12]*cos(x[9] - y[3]);
out[1308] = y[11]*cos(x[9] - y[3]) - y[12]*sin(x[9] - y[3]);
out[1309] = y[2]*y[11]*sin(x[9] - y[3]) + y[2]*y[12]*cos(x[9] - y[3]);
out[1317] = y[2]*cos(x[9] - y[3]);
out[1318] = -y[2]*sin(x[9] - y[3]);
out[1339] = ((p[47] > p[44]*(-x[13] + u[9] + u[8]) + p[45]*x[14] || p[48] < p[44]*(-x[13] + u[9] + u[8]) + p[45]*x[14]) ? (
   0
)
: (
   -p[44]
));
out[1340] = ((p[47] > p[44]*(-x[13] + u[9] + u[8]) + p[45]*x[14] || p[48] < p[44]*(-x[13] + u[9] + u[8]) + p[45]*x[14]) ? (
   0
)
: (
   p[45]
...
out[76] = 0.5*p[15]/p[8];
out[80] = -1/p[9];
out[101] = (p[13] - p[11])/p[9];
out[105] = 1.0/p[9];
out[120] = -1/p[10];
out[141] = (-p[14] + p[12])/p[10];
out[160] = -1/p[21];
out[175] = 1.0/p[21];
out[199] = p[19]*p[24] - 1.0;
out[200] = -p[20]*p[24];
out[222] = p[24];
out[240] = -1/p[26];
out[262] = 1.0/p[26];
...
out[361] = p[32];
out[388] = -p[32];
out[400] = -0.5*p[40]/p[33];
out[426] = 0.5/p[33];
out[427] = 0.5*p[40]/p[33];
out[440] = -1/p[34];
out[459] = (p[38] - p[36])/p[34];
out[463] = 1.0/p[34];
out[480] = -1/p[35];
out[499] = (-p[39] + p[37])/p[35];
out[520] = -1/p[46];
out[528] = 1.0/p[46];
out[559] = p[44]*p[49] - 1.0;
out[560] = -p[45]*p[49];
out[580] = p[49];
out[600] = -1/p[51];
out[620] = 1.0/p[51];
...
out[1403] = p[43];
out[1419] = p[52]/p[53];
out[1420] = -p[52]/p[53] + 1.0;
out[1444] = p[8]*p[6]/(p[8]*p[6] + p[33]*p[31]);
out[1453] = p[33]*p[31]/(p[8]*p[6] + p[33]*p[31]);
out[1500] = p[57];
out[1519] = -p[56];
...
out[320] = -9.9999999999999995e-7;
out[680] = -9.9999999999999995e-7;
out[739] = -1.0;
out[899] = -1.0;
out[939] = -1.0;
out[1000] = -1.0;
...
out[30] = 0.5*(-y[2]*y[11]*cos(x[9] - y[3]) + y[2]*y[12]*sin(x[9] - y[3]))/p[33];
out[32] = 0.5*(-y[11]*sin(x[9] - y[3]) - y[12]*cos(x[9] - y[3]))/p[33];
out[33] = 0.5*(y[2]*y[11]*cos(x[9] - y[3]) - y[2]*y[12]*sin(x[9] - y[3]))/p[33];
out[34] = 0.5*(-2.0*p[41]*y[11] - y[2]*sin(x[9] - y[3]))/p[33];
out[35] = 0.5*(-2.0*p[41]*y[12] - y[2]*cos(x[9] - y[3]))/p[33];
out[55] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[56] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[57] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[58] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[60] = 2.0*y[0]*(-p[2] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[61] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[62] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[63] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[65] = y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[66] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[67] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*p[1];
out[68] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[70] = y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[71] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[72] = y[0]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + 2.0*y[2]*(-p[2] - 0.5*p[3]);
...
out[99] = ((p[22] > p[19]*(-x[4] + u[5] + u[4]) + p[20]*x[5] || p[23] < p[19]*(-x[4] + u[5] + u[4]) + p[20]*x[5]) ? (
   0
)
: (
   -p[19]
));
out[100] = ((p[22] > p[19]*(-x[4] + u[5] + u[4]) + p[20]*x[5] || p[23] < p[19]*(-x[4] + u[5] + u[4]) + p[20]*x[5]) ? (
   0
)
: (
   p[20]
));
out[109] = -y[2]*sin(x[9] - y[3]);
out[111] = cos(x[9] - y[3]);
out[112] = y[2]*sin(x[9] - y[3]);
out[115] = y[2]*cos(x[9] - y[3]);
out[117] = sin(x[9] - y[3]);
out[118] = -y[2]*cos(x[9] - y[3]);
out[121] = y[2]*y[11]*cos(x[9] - y[3]) - y[2]*y[12]*sin(x[9] - y[3]);
out[122] = y[11]*sin(x[9] - y[3]) + y[12]*cos(x[9] - y[3]);
out[123] = -y[2]*y[11]*cos(x[9] - y[3]) + y[2]*y[12]*sin(x[9] - y[3]);
out[124] = y[2]*sin(x[9] - y[3]);
out[125] = y[2]*cos(x[9] - y[3]);
out[127] = -y[2]*y[11]*sin(x[9] - y[3]) - y[2]*y[12]*cos(x[9] - y[3]);
out[128] = y[11]*cos(x[9] - y[3]) - y[12]*sin(x[9] - y[3]);
out[129] = y[2]*y[11]*sin(x[9] - y[3]) + y[2]*y[12]*cos(x[9] - y[3]);
out[130] = y[2]*cos(x[9] - y[3]);
out[131] = -y[2]*sin(x[9] - y[3]);
out[133] = ((p[47] > p[44]*(-x[13] + u[9] + u[8]) + p[45]*x[14] || p[48] < p[44]*(-x[13] + u[9] + u[8]) + p[45]*x[14]) ? (
   0
)
: (
   -p[44]
));
out[134] = ((p[47] > p[44]*(-x[13] + u[9] + u[8]) + p[45]*x[14] || p[48] < p[44]*(-x[13] + u[9] + u[8]) + p[45]*x[14]) ? (
   0
)
: (
   p[45]
...
out[28] = p[32];
out[29] = -p[32];
out[31] = -0.5*p[40]/p[33];
out[36] = 0.5/p[33];
out[37] = 0.5*p[40]/p[33];
out[38] = -1/p[34];
out[39] = (p[38] - p[36])/p[34];
out[40] = 1.0/p[34];
out[41] = -1/p[35];
out[42] = (-p[39] + p[37])/p[35];
out[43] = -1/p[46];
out[44] = 1.0/p[46];
out[45] = p[44]*p[49] - 1.0;
out[46] = -p[45]*p[49];
out[47] = p[49];
out[48] = -1/p[51];
out[49] = 1.0/p[51];
...
out[139] = p[43];
out[140] = p[52]/p[53];
out[141] = -p[52]/p[53] + 1.0;
out[143] = p[8]*p[6]/(p[8]*p[6] + p[33]*p[31]);
out[144] = p[33]*p[31]/(p[8]*p[6] + p[33]*p[31]);
out[146] = p[57];
out[147] = -p[56];
...
out[39] = -0.25*Dt*(-y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]))/p[8];
out[58] = -0.25*Dt*(-y[4]*sin(x[0] - y[1]) - y[5]*cos(x[0] - y[1]))/p[8];
out[59] = -0.25*Dt*(y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]))/p[8];
out[62] = -0.25*Dt*(-2.0*p[16]*y[4] - y[0]*sin(x[0] - y[1]))/p[8];
out[63] = -0.25*Dt*(-2.0*p[16]*y[5] - y[0]*cos(x[0] - y[1]))/p[8];
out[399] = -0.25*Dt*(-y[2]*y[11]*cos(x[9] - y[3]) + y[2]*y[12]*sin(x[9] - y[3]))/p[33];
out[411] = -0.25*Dt*(-y[11]*sin(x[9] - y[3]) - y[12]*cos(x[9] - y[3]))/p[33];
out[412] = -0.25*Dt*(y[2]*y[11]*cos(x[9] - y[3]) - y[2]*y[12]*sin(x[9] - y[3]))/p[33];
out[420] = -0.25*Dt*(-2.0*p[41]*y[11] - y[2]*sin(x[9] - y[3]))/p[33];
out[421] = -0.25*Dt*(-2.0*p[41]*y[12] - y[2]*cos(x[9] - y[3]))/p[33];
out[760] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[761] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[762] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[763] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
...
out[1] = -0.5*Dt*p[7];
out[37] = 0.5*Dt*p[7];
out[40] = 0.25*p[15]*Dt/p[8] + 1.0;
out[68] = -0.25*Dt/p[8];
out[76] = -0.25*p[15]*Dt/p[8];
out[80] = 0.5*Dt/p[9] + 1.0;
out[101] = -0.5*Dt*(p[13] - p[11])/p[9];
out[105] = -0.5*Dt/p[9];
out[120] = 0.5*Dt/p[10] + 1.0;
out[141] = -0.5*Dt*(-p[14] + p[12])/p[10];
out[160] = 0.5*Dt/p[21] + 1.0;
out[175] = -0.5*Dt/p[21];
out[199] = -0.5*Dt*(p[19]*p[24] - 1.0);
out[200] = 0.5*Dt*p[20]*p[24] + 1.0;
out[222] = -0.5*Dt*p[24];
out[240] = 0.5*Dt/p[26] + 1.0;
out[262] = -0.5*Dt/p[26];
out[279] = -0.5*Dt/p[28];
out[280] = 0.5*Dt/p[28] + 1.0;
out[320] = 4.9999999999999998e-7*Dt + 1.0;
out[337] = 0.5*Dt*p[29];
out[360] = 0.5*Dt*p[42] + 1.0;
out[361] = -0.5*Dt*p[32];
out[388] = 0.5*Dt*p[32];
out[400] = 0.25*p[40]*Dt/p[33] + 1.0;
out[426] = -0.25*Dt/p[33];
out[427] = -0.25*p[40]*Dt/p[33];
out[440] = 0.5*Dt/p[34] + 1.0;
out[459] = -0.5*Dt*(p[38] - p[36])/p[34];
out[463] = -0.5*Dt/p[34];
out[480] = 0.5*Dt/p[35] + 1.0;
out[499] = -0.5*Dt*(-p[39] + p[37])/p[35];
out[520] = 0.5*Dt/p[46] + 1.0;
out[528] = -0.5*Dt/p[46];
out[559] = -0.5*Dt*(p[44]*p[49] - 1.0);
out[560] = 0.5*Dt*p[45]*p[49] + 1.0;
out[580] = -0.5*Dt*p[49];
out[600] = 0.5*Dt/p[51] + 1.0;
out[620] = -0.5*Dt/p[51];
out[639] = -0.5*Dt/p[53];
out[640] = 0.5*Dt/p[53] + 1.0;
out[680] = 4.9999999999999998e-7*Dt + 1.0;
out[695] = 0.5*Dt*p[54];
out[739] = 0.5*Dt;
out[766] = -p[6]/p[0];
out[806] = -p[6]/p[0];
...
out[30] = -0.25*Dt*(-y[2]*y[11]*cos(x[9] - y[3]) + y[2]*y[12]*sin(x[9] - y[3]))/p[33];
out[32] = -0.25*Dt*(-y[11]*sin(x[9] - y[3]) - y[12]*cos(x[9] - y[3]))/p[33];
out[33] = -0.25*Dt*(y[2]*y[11]*cos(x[9] - y[3]) - y[2]*y[12]*sin(x[9] - y[3]))/p[33];
out[34] = -0.25*Dt*(-2.0*p[41]*y[11] - y[2]*sin(x[9] - y[3]))/p[33];
out[35] = -0.25*Dt*(-2.0*p[41]*y[12] - y[2]*cos(x[9] - y[3]))/p[33];
out[56] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[57] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[58] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[59] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[61] = 2.0*y[0]*(-p[2] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[62] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[63] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[64] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[66] = y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[67] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[68] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*p[1];
out[69] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[71] = y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[72] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[73] = y[0]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + 2.0*y[2]*(-p[2] - 0.5*p[3]);
out[74] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[76] = -y[0]*sin(x[0] - y[1]);
out[78] = cos(x[0] - y[1]);
out[79] = y[0]*sin(x[0] - y[1]);
out[82] = y[0]*cos(x[0] - y[1]);
out[84] = sin(x[0] - y[1]);
out[85] = -y[0]*cos(x[0] - y[1]);
out[88] = y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]);
out[89] = y[4]*sin(x[0] - y[1]) + y[5]*cos(x[0] - y[1]);
out[90] = -y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]);
out[91] = y[0]*sin(x[0] - y[1]);
out[92] = y[0]*cos(x[0] - y[1]);
out[94] = -y[0]*y[4]*sin(x[0] - y[1]) - y[0]*y[5]*cos(x[0] - y[1]);
out[95] = y[4]*cos(x[0] - y[1]) - y[5]*sin(x[0] - y[1]);
out[96] = y[0]*y[4]*sin(x[0] - y[1]) + y[0]*y[5]*cos(x[0] - y[1]);
out[97] = y[0]*cos(x[0] - y[1]);
...
out[101] = ((p[22] > p[19]*(-x[4] + u[5] + u[4]) + p[20]*x[5] || p[23] < p[19]*(-x[4] + u[5] + u[4]) + p[20]*x[5]) ? (
   0
)
: (
   p[20]
));
out[110] = -y[2]*sin(x[9] - y[3]);
out[112] = cos(x[9] - y[3]);
out[113] = y[2]*sin(x[9] - y[3]);
out[116] = y[2]*cos(x[9] - y[3]);
out[118] = sin(x[9] - y[3]);
out[119] = -y[2]*cos(x[9] - y[3]);
out[122] = y[2]*y[11]*cos(x[9] - y[3]) - y[2]*y[12]*sin(x[9] - y[3]);
out[123] = y[11]*sin(x[9] - y[3]) + y[12]*cos(x[9] - y[3]);
out[124] = -y[2]*y[11]*cos(x[9] - y[3]) + y[2]*y[12]*sin(x[9] - y[3]);
out[125] = y[2]*sin(x[9] - y[3]);
out[126] = y[2]*cos(x[9] - y[3]);
out[128] = -y[2]*y[11]*sin(x[9] - y[3]) - y[2]*y[12]*cos(x[9] - y[3]);
out[129] = y[11]*cos(x[9] - y[3]) - y[12]*sin(x[9] - y[3]);
out[130] = y[2]*y[11]*sin(x[9] - y[3]) + y[2]*y[12]*cos(x[9] - y[3]);
out[131] = y[2]*cos(x[9] - y[3]);
out[132] = -y[2]*sin(x[9] - y[3]);
out[134] = ((p[47] > p[44]*(-x[13] + u[9] + u[8]) + p[45]*x[14] || p[48] < p[44]*(-x[13] + u[9] + u[8]) + p[45]*x[14]) ? (
   0
)
: (
...
out[135] = ((p[47] > p[44]*(-x[13] + u[9] + u[8]) + p[45]*x[14] || p[48] < p[44]*(-x[13] + u[9] + u[8]) + p[45]*x[14]) ? (
   0
)
: (
   p[45]
...
out[16] = 0.5*Dt/p[21] + 1.0;
out[17] = -0.5*Dt/p[21];
out[18] = -0.5*Dt*(p[19]*p[24] - 1.0);
out[19] = 0.5*Dt*p[20]*p[24] + 1.0;
out[20] = -0.5*Dt*p[24];
out[21] = 0.5*Dt/p[26] + 1.0;
out[22] = -0.5*Dt/p[26];
out[23] = -0.5*Dt/p[28];
out[24] = 0.5*Dt/p[28] + 1.0;
out[25] = 4.9999999999999998e-7*Dt + 1.0;
out[26] = 0.5*Dt*p[29];
out[27] = 0.5*Dt*p[42] + 1.0;
out[28] = -0.5*Dt*p[32];
out[29] = 0.5*Dt*p[32];
out[31] = 0.25*p[40]*Dt/p[33] + 1.0;
out[36] = -0.25*Dt/p[33];
out[37] = -0.25*p[40]*Dt/p[33];
out[38] = 0.5*Dt/p[34] + 1.0;
out[39] = -0.5*Dt*(p[38] - p[36])/p[34];
out[40] = -0.5*Dt/p[34];
out[41] = 0.5*Dt/p[35] + 1.0;
out[42] = -0.5*Dt*(-p[39] + p[37])/p[35];
out[43] = 0.5*Dt/p[46] + 1.0;
out[44] = -0.5*Dt/p[46];
out[45] = -0.5*Dt*(p[44]*p[49] - 1.0);
out[46] = 0.5*Dt*p[45]*p[49] + 1.0;
out[47] = -0.5*Dt*p[49];
out[48] = 0.5*Dt/p[51] + 1.0;
out[49] = -0.5*Dt/p[51];
out[50] = -0.5*Dt/p[53];
out[51] = 0.5*Dt/p[53] + 1.0;
...
out[140] = p[43];
out[141] = p[52]/p[53];
out[142] = -p[52]/p[53] + 1.0;
out[144] = p[8]*p[6]/(p[8]*p[6] + p[33]*p[31]);
out[145] = p[33]*p[31]/(p[8]*p[6] + p[33]*p[31]);
out[147] = p[57];
out[148] = -p[56];
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_smib_avr_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_smib_avr_cffi(void) { return NULL; }
#  else
     initsmib_avr_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_smib_avr_cffi(void)
{
  return _cffi_init("smib_avr_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initsmib_avr_cffi(void)
{
  _cffi_init("smib_avr_cffi", 0x2601, &_cffi_type_context);
}
#endif
